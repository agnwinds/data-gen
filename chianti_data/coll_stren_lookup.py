...
240125 - Updated to python3 and tested on current verions of chianti
...
inp=open("lines_linked_ver_2.dat","r")
...
for line in inp.readlines():
    ...
    try:
        ...
        print('Error in lines_linkded %d %s' % (jjj,line))
        continue
    ...
    if os.path.isfile(fname) and f !=0:
        ...
        for i in range(0,len(lines),3):
            ...
            try:
                ...
                print('Error: on line %d of %s with %s' % (i,fname,lines[i]))
                continue
